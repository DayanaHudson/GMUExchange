    ...
    function dashboard(id, fData){
        ...
        function segColor(c){ return {textbooks:"#807dba", classNotes:"#e08214", classMaterials:'#ffff00', misc:"#41ab5d"}[c]; }

        // compute total for each Month.
        fData.forEach(function(d){d.total=d.freq.textbooks+d.freq.classNotes+d.freq.classMaterials+d.freq.misc;});
        ...
        function histoGram(fD){
            ...
            bars.append("rect")
                ...
                .attr('fill',barColor)
                .on("mouseover",mouseover)// mouseover is defined betextbooks.
                .on("mouseout",mouseout);// mouseout is defined betextbooks.

            //Create the frequency labels above the rectangles.
            bars.append("text").text(function(d){ return d3.format(",")(d[1])})
                .attr("x", function(d) { return x(d[0])+x.rangeBand()/2; })
                .attr("y", function(d) { return y(d[1])-5; })
                .attr("text-anchor", "classNotesdle");
        ...
        var tF = ['textbooks','classNotes','classMaterials','misc'].map(function(d){
